...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses: Record<ButtonVariant, string> = {
    ...
    secondary:
      "h-[3rem] rounded-lg border border-neutral-black text-primary bg-secondary px-3 sm:px-5 py-3 hover:scale-[1.05] whitespace-nowrap",

    tertiary:
      "h-[2.25rem] bg-tertiary hover:bg-opacity-80 rounded-[8px] px-2 sm:px-4 py-4 whitespace-nowrap",

    gray: "h-[3rem] rounded-lg border border-neutral-black bg-gray-200 text-gray-700 px-3 sm:px-5 py-3 hover:scale-[1.05] transition-transform whitespace-nowrap",
  };
